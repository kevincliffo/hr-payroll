   ...
   /* public function Salary_List(){
    ...
    public function load_employee_Invoice_by_EmId_for_pay()
    {
        ...
        //die($year); 
            ...
            echo "<div class='row payslip_print' id='payslip_print' style='font-family:Calibri;'>
                    <div class='col-md-12'>
                        <div class='card card-body'>
                            <div class='row'>
                                <div class='col-md-4 col-xs-6 col-sm-6'>
                                    <img src='$base/assets/images/logo-icon.png' style=' width:180px; margin-right: 10px;' />
                                </div>
                            ...
                            <div class='row' style='margin-bottom: 5px;'>
                                <div class='col-md-12'>
                                    <table class='table table-condensed borderless payslip_info' style='margin-bottom: 5px;font-family:Calibri;font-size:18px;'>
                                        <tr>
                                            <td>Employee PIN</td>
                            ...
                            <div class='row'>
                                <div class='col-md-12'>
                                    <table class='table table-condensed borderless' style='border-left: 1px solid #ececec;font-family:Calibri;font-size:18px;'>
                                        ...
                                        <tbody style='border: 1px solid #ececec;'>
                                            <tr>
                                                <td>Basic Salary</td>
                                                <td class='text-right'>Ksh ". $addition[0]->basic; echo"</td>
                                                <td class='text-right'>  </td>
                                            </tr>
                                            <tr>
                                                <td>Madical Allowance</td>
                                                <td class='text-right'>Ksh ". $addition[0]->medical; echo "</td>
                                                <td class='text-right'>  </td>
                                            </tr>
                                            <tr>
                                                <td>House Rent</td>
                                                <td class='text-right'>Ksh ".$addition[0]->house_rent; echo "</td>
                                                <td class='text-right'>  </td>
                                            </tr>
                                            <tr>
                                                <td>Conveyance Allowance</td>
                                                <td class='text-right'>Ksh ".$addition[0]->conveyance; echo "</td>
                                                <td class='text-right'>  </td>
                                            </tr>
                                            <tr>
                                                <td>Bonus</td>
                                        ...
                                        <tfoot class='tfoot-light'>
                                            <tr>
                                                <th>Total</th>
                                                <th class='text-right'>Ksh ". $total_add = $salary_info->basic + $salary_info->medical + $salary_info->house_rent + $salary_info->bonus; "Ksh ".round($total_add,2); echo "</th>
                                                <th class='text-right'>Ksh ".$total_did = $salary_info->loan + $salary_info->diduction;  "Ksh ".round($total_did,2); echo"</th>
                                            </tr>
                                            <tr>
                                                <th></th>
                                                <th class='text-right'>Net Pay</th>
                                                <th class='text-right'>Ksh $salary_info->total_pay</th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
