                        ...
                        <div class="card card-body">
                            <div class="row">
                                <div class="col-md-4 col-xs-6 col-sm-6">
                                    <img src="<?php echo base_url();?>assets/images/logo-icon.png" style=" width:180px; margin-right: 10px;" />
                                </div>
                                ...
                                <div class="col-md-12">
                                    <table class="table table-condensed borderless" style="border-left: 1px solid #ececec;">
                                        ...
                                        <tbody style="border: 1px solid #ececec;">
                                            <tr>
                                                <td>Basic Salary</td>
                                                <td class="text-right">Ksh <?php echo $addition[0]->basic; ?></td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <tr>
                                                <td>Madical Allowance</td>
                                                <td class="text-right">Ksh <?php echo $addition[0]->medical; ?></td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <tr>
                                                <td>House Rent</td>
                                                <td class="text-right">Ksh <?php echo $addition[0]->house_rent; ?></td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <tr>
                                                <td>Conveyance Allowance</td>
                                                <td class="text-right">Ksh <?php echo $addition[0]->conveyance; ?></td>
                                                <td class="text-right">  </td>
                                            </tr>
                                            <tr>
                                                <td>Bonus</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <?php
                                                        if($a > 0) { echo "Ksh ".round($a,2); }
                                                    ?>
                                                </td>
                                                <td class="text-right">
                                                    <?php
                                                        if($d > 0) { echo "Ksh ".round($d,2); }
                                                    ?>        
                                                </td>
                                                <td class="text-right"> </td>
                                            </tr>
                                            <!--<tr>
                                                ...
                                                <td class="text-right"> <?php
                                                        ...
                                                        echo "Ksh ".$salary_info->diduction;
                                                    ?> </td>
                                        ...
                                        <tfoot class="tfoot-light">
                                            <tr>
                                                <th>Total</th>
                                                <th class="text-right"><?php $total_add = $salary_info->basic + $salary_info->medical + $salary_info->house_rent + $salary_info->bonus+$a; echo "Ksh ".round($total_add,2); ?></th>
                                                <th class="text-right"><?php $total_did = $salary_info->loan+$salary_info->diduction; echo "Ksh ".round($total_did,2); ?></th>
                                            </tr>
                                            <tr>
                                                <th></th>
                                                <th class="text-right">Net Pay</th>
                                                <th class="text-right"><?php echo "Ksh ".$salary_info->total_pay/*round($total_add - $total_did,2)*/; ?></th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="pull-left " style="height:80px;margin-left:10px;">
                                        <img src="<?php echo base_url();?>assets/images/logo-icon.png" style="position:absolute; top:0; left:0;width:250px;margin-left:15px;" />
                                    </div>
                                    ...
                                    <div class="table-responsive" style="clear: both;">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>Basic Salary</td>
                                                    <td class="text-right">Ksh <?php echo $salaryvaluebyid->basic;?></td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                <tr>
                                                    <td>Madical</td>
                                                    <td class="text-right">Ksh <?php echo $salaryvaluebyid->medical;?></td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                <tr>
                                                    <td>House Rent</td>
                                                    <td class="text-right"> Ksh <?php echo $salaryvaluebyid->house_rent;?> </td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                <tr>
                                                    <td>Conveyance</td>
                                                    <td class="text-right"> Ksh <?php echo $salaryvaluebyid->conveyance;?> </td>
                                                    <td class="text-right">  </td>
                                                </tr>
                                                <tr>
                                                    <td>Loan</td>
                                                    <td class="text-right"> </td>
                                                    <td class="text-right">Ksh <?php echo $salary_info->loan;?></td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
                                                <tr>
                                                    <th>Total</th>
                                                    <th class="text-right">Ksh <?php echo $salaryvaluebyid->total;?></th>
                                                    <th class="text-right">Ksh <?php echo $salary_info->diduction;?></th>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="pull-right m-t-30 text-right">
                                        <h3><b>Total :</b>  Ksh <?php echo $salary_info->total_pay;?></h3>
                                    </div>
