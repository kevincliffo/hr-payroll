            ...
            <footer class="footer" style="font-family:Calibri;font-size:18px"> © <?php echo date('Y');?> TIKVAH Solutions </footer>
        </div>
    ...
    <script src="<?php echo base_url(); ?>assets/js/clocking.js"></script>
