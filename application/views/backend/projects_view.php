                                ...
                                <br/>
                                    ...
                                    <div class="modal-footer">
                                       <input type="hidden" name="proid" value="<?php echo $details->id; ?>">
                                        <button type="button" onclick="printProject()" class="btn btn-primary" data-dismiss="modal">Print</button>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive ">
                                            <table id="projects123" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="10%">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th>Employee Name</th>
