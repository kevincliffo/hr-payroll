...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 23, 2021 at 12:11 AM
...
CREATE TABLE `donors` (
  ...
  `donor_phone_number` varchar(64) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 'Och1020', 'EMP-2021-001', 13, 5, 'Kevin', 'Ochieng', 'kevincliffo@gmail.com', '2bd159e94401a6eec125a238d4ecfb3fedd6fdd1', 'SUPER ADMIN', NULL, 'ACTIVE', 'Male', '+254725026722', '1990-07-20', 'O+', '2021-03-20', '', 'Och1020.jpeg', '21223455');
...
CREATE TABLE `project` (
  ...
  `pro_donor` varchar(512) DEFAULT NULL,
...
--
ALTER TABLE `leave_types`
  MODIFY `type_id` int(14) NOT NULL AUTO_INCREMENT;
